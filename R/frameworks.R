...
#' Use BAB framework to create a prompt
#'
#' @param before
#' @param after
#' @param bridge
...
#' Use Chain of Thought framework to create a prompt
#'
#' @param instructions
#' @param template string to format the examples
#' @param copy_to_clipboard boolean to copy to clipboard
...
#' Use Chain of Destiny framework to create a prompt
#'
#' @param instructions
#' @param recursion
#' @param benchmark
#' @param additional_guidelines
#' @param template string to format the examples
#' @param copy_to_clipboard boolean to copy to clipboard
#'
#' @return
